...
This generated workflow is the shared source of truth for mandatory and optional AI-SDLC initialization steps in `graphwiki` (topology: standalone, depth 0).
...
Generated `AGENTS.md` and `README.md` must link to this workflow doc and `.ai/workflows/repo-workflow.json`. `CLAUDE.md` and `GEMINI.md` are thin pointers to `AGENTS.md` (ADR-0003) and are not entry surfaces.
